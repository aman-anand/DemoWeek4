...
public class DefaultCameraApp extends AppCompatActivity {
    ...
    private static final String IMAGE_DIRECTORY_NAME = "AmanCamera";

    private Uri fileUri; // file url to store image/video

    private ImageView imgPreview;
    private VideoView videoPreview;
    private Button btnCapturePicture, btnRecordVideo, gallery;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.device_camera_layout);
        init();
...
//                        .show();
            ...
            if (resultCode == RESULT_CANCELED) {
                ...
                try {
                    ...
                    imgPreview.setImageBitmap(MediaStore.Images.Media.getBitmap(this.getContentResolver(), selectedimg));
                } catch (IOException e) {
                    e.printStackTrace();
                }
            } else {
